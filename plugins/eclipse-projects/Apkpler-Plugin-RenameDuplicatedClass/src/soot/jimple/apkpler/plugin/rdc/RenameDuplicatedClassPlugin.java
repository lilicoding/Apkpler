package soot.jimple.apkpler.plugin.rdc;
 ...
 *
 */
public class RenameDuplicatedClassPlugin extends DefaultPlugin 
{
	...
	public void sceneTransform() 
	{
		...
		System.out.println("Case In-Sensitive File System.");
		
		String fixedClassNamesStr = this.getInput();
